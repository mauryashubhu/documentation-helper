...
# vector = embeddings.embed_query("hellorld!")
# print(vector[:5])
# vectorstore = Chroma(persist_directory='chroma_db', embedding_function=embeddings) # for local direcotry db will create 
vectorstore = PineconeVectorStore(index_name="lanchain-doc-google", embedding=embeddings)
tavily_extract = TavilyExtract()
tavily_map = TavilyMap(max_depth=5, max_breadth=20, max_pages=1000)
tavily_crawl = TavilyCrawl()  # (tavily_extract + tavily_map) best of both worlds
